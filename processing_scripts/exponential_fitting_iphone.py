...
def process_folder(input_folder, output_folder, use_log_decay=False):
    ...
    for file_name in os.listdir(input_folder):
        if file_name.endswith(".csv"):
            ...
            plt.plot(x_end, y_end_monotonic, color='purple', linestyle=':', label='Maximum Envelope')
...
input_folder = 'input_data_iphone'
process_folder(input_folder, 'output_data_iphone_exp', use_log_decay=False)
process_folder(input_folder, 'output_data_iphone_log', use_log_decay=True)
